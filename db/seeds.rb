...
Reference.create!(
  ...
  site_name: '結姫',
  author: 'アクティライフ株式会社',
  author_furigana: 'あくてぃらいふかぶしきがいしゃ',
  accessed_on: Date.new(2025, 10, 19),
  url: 'https://musubime-japan.com/html/page50.html'
)

Reference.create!(
  title: '弔事 仏式 髙島屋の御贈答マナー',
  site_name: '髙島屋',
  author: '株式会社髙島屋',
  author_furigana: 'かぶしきがいしゃたかしまや',
  accessed_on: Date.new(2025, 10, 20),
  url: 'https://www.takashimaya.co.jp/giftnavi/chouji_01.html'
)

Reference.create!(
  title: '通夜見舞いとは？渡す品物・注意点・マナーなど地域の風習を詳しく解説',
  site_name: '小さなお葬式',
  author: '株式会社ユニクエスト',
